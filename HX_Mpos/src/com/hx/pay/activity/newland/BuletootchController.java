 ...
 * @since ver1.0
 */
public interface BuletootchController {
	/**
	 * 初始化设备控制器
	 * 
	 * @since ver1.0
	 ...
	 * @param listener
	 */
	public void startTransfer(Context context, OpenCardType[] cardReaders, String msg, BigDecimal amount, long timeout, TimeUnit timeunit, CardRule opencardrule,SimpleTransferListener transferListener) throws Exception;
