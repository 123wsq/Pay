...
public final class ViewfinderView extends View
{
    ...
    public void onDraw(Canvas canvas)
    {
        ...
        else
        {
            ...
            //
            float w = paint.measureText(getResources().getString(R.string.msg_default_status));
            canvas.drawText(
                    getResources().getString(R.string.msg_default_status),
                    (screenWidth -w) / 2, frame.bottom + TEXT_PADDING_TOP * density,
                    paint);
